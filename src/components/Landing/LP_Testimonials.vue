            ...
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    ...
                    <p class="text-2xl font-medium text-gray-900 dark:text-white">
                        ...
                        Avec cet outil, tout est clair : je renseigne simplement les informations nécessaires, et je sais instantanément la bonne quantité d’eau et de lait en poudre à utiliser.<br><br>
                ...
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    <img class="w-8 h-8 rounded-full object-cover"
                        src="https://agence.jeremiecode.fr/assets/images/testimonials/img-4.jpg"
                        alt="profile picture">
                    <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                        <div class="pr-3 font-medium text-gray-900 dark:text-white">Amandine C.</div>
                        <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Auxiliaire petite enfance - Les gentils canassons (Crèche privée)</div>
                    </div>
                </figcaption>
            </figure>
        </div>
