            ...
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    ...
                    <p class="text-2xl font-medium text-gray-900 dark:text-white">
                        ...
                        Avec cet outil, tout est clair : je renseigne simplement les informations nécessaire, et je sais instantanément la bonne quantité d’eau et de lait en poudre à utiliser.<br><br>
