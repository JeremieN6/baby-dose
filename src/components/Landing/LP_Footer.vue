...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">        
        ...
        <p class="my-6 text-gray-500 dark:text-gray-400">BabyDose™ – votre allié pour bien doser.</p>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a
                class="hover:underline ">BabyDose™</a>. <br> <br> Site web réalisé avec 💖 par <a href="https://jeremiecode.fr">SnapCode™ Agency</a> • All Rights Reserved. </span>
    </div>
</footer>
<!-- Footer -->
    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                 <RouterLinker to="/" class="flex items-center">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                             <RouterLinker to="/" class="hover:underline">Flowbite</RouterLinker
                        </li>
                        <li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://jeremiecode.fr" class="hover:underline">Flowbite™</a>. All Rights Reserved.
            </span>
